...
const AllCoursesHero = () => {
  return (
    <section className="relative w-full overflow-hidden mt-28" style={{ background: "linear-gradient(135deg, #ede9f6 0%, #f5f0fb 40%, #fdf0f8 70%, #fce8f3 100%)", minHeight: "320px" }}>
