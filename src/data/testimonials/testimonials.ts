...
export const testimonials: TestimonialData[] = [
  {
    id: "1",
    quote: "Proximsoft was rated the most popular online course or certification program for learning how to code according to StackOverflow's 2023 Developer survey.",
  ...
  {
    id: "2",
    quote: "Proximsoft was truly a game-changer and a great guide for me as we brought Dimensional to life. The depth of the iOS content is unmatched.",
    author: "Alvin Lim",
  ...
  {
    id: "3",
    quote: "Proximsoft gives you the ability to be persistent. I learned exactly what I needed to know in the real world. It helped me sell myself to get a new role.",
  ...
  {
    id: "4",
    quote: "With Proximsoft Business, employees were able to marry the two together: technology and consultant soft skills... to help drive their careers forward.",
    author: "Ian Stevens",
